...
#    name = sys.argv[1]										# Get the filename
    ...
    sys.stdout = open(full_path + ".TXT", "w", encoding='utf-8')		# Redirect stdout for the detokenised file output
    ...
    while True:
        ...
        if byte == 0x0D:									# If it is CR then
            ...
            break;											# Exit the loop
        elif byte < 0x80 or comment:						# If it is a printable character - comments allow all character codes
